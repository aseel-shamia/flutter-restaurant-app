// lib/features/home/presentation/all_restaurants_all_screen.dart
...
/// شاشة All Restaurants التي تفتح من زر See all
class AllRestaurantsAllScreen extends StatelessWidget {
  const AllRestaurantsAllScreen({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    // بيانات المطاعم لقسم All Restaurants
            ...
            Padding(
              ...
              child: Row(
                children: [
                  ...
                  Text(
                    'all_restaurants_title'.tr(), // أضف المفتاح في JSON
                    style: TextStyle(
                      fontSize: 18,
